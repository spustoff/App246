        ...
        ZStack {
            ...
            VStack {
                    ...
                    LazyVStack {
                        ...
                        ZStack(alignment: .leading, content: {
                            ...
                            Text("$ Budget")
                                .foregroundColor(.gray)
                                .font(.system(size: 15, weight: .regular))
                                .opacity(ZwpFhsvTpS.gROOdOOYPv.isEmpty ? 1 : 0)
                            
                            TextField("", text: $ZwpFhsvTpS.gROOdOOYPv)
                                .foregroundColor(.black)
                                .font(.system(size: 15, weight: .regular))
                ...
                Button(action: {
                    ...
                    ZwpFhsvTpS.XmkUBjhvBH(completion: {
                        
                        ZwpFhsvTpS.name = ""
                        ZwpFhsvTpS.tqGOorDdPh = ""
                        ZwpFhsvTpS.gROOdOOYPv = ""
                ...
                .opacity(ZwpFhsvTpS.name.isEmpty || ZwpFhsvTpS.tqGOorDdPh.isEmpty || ZwpFhsvTpS.gROOdOOYPv.isEmpty ? 0.5 : 1)
                .disabled(ZwpFhsvTpS.name.isEmpty || ZwpFhsvTpS.tqGOorDdPh.isEmpty || ZwpFhsvTpS.gROOdOOYPv.isEmpty ? true : false)
            }
        }
    }
}
...
#Preview {
    HGLmFsnCOF(ZwpFhsvTpS: qegcINwKKF())
}
